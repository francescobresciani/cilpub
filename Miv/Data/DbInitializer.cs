    ...
    public static class DbInitializer
    {
        public static void Initialize(MivContext context)
        {
            ...
            var materials = new Material[]
            {
                ...
                new Material{MaterialID=10,Name="1st child of 1",Description="i am a child",imgUrl="images/04.jpg"},
                new Material{MaterialID=11,Name="2nd child of 1",Description="i am a child",imgUrl="images/05.jpg"},
                new Material{MaterialID=12,Name="3rd child of 1",Description="i am a child",imgUrl="images/06.jpg"},
                new Material{MaterialID=21,Name="only child of 2",Description="i am a child",imgUrl="images/07.jpg"}
            };
