...
namespace CadViewer.Controllers
{
    public class MaterialsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,name,description,imageUrl")] Material material)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,name,description,imageUrl")] Material material)
        {
            if (id != material.ID)
            {
                return NotFound();
